...
def build_vocab_audio(max_size: int, min_freq: int, dataset: Dataset,
                vocab_file: str = None) -> Vocabulary:
    ...
    if vocab_file is not None:
        ...
        tokens = []
        for i in dataset:
            # See AudioDataset.__getitem__()'s return value
            waveform, sample_rate, dic = i[0], i[1], i[2]
            sentence = dic['sentence']
            tokens.extend(sentence) # TODO: Do we need to preprocess here?
